...
export class OrderDetailsController {
    ...
    findOne(@Param('orderId') orderId: string, @Param('articleId') articleId: string) {
    ...
    update(@Param('orderId') orderId: string, @Param('articleId') articleId: string, @Body() updateOrderDetailDto : UpdateOrderDetailDto) {
        if(!orderId || !articleId) throw new BadRequestException('Order required or article required');
    ...
    remove(@Param('orderId') orderId: string, @Param('articleId') articleId: string) {
        if(!orderId || !articleId) throw new BadRequestException('Order required or article required');
